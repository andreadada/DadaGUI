...
public class BackItem extends PageItem {
    ...
    public BackItem(AbstractItemBuilder<ItemBuilder> builder, String displayName, String lore, String maxReached) {
        super(false);
    ...
    public BackItem(Platform platform, AbstractItemBuilder<ItemBuilder> builder, String displayName, String lore, String maxReached) {
        super(false);
        this.wrapper = builder;
        this.displayName = displayName;
        this.lore = lore;
    ...
    public ItemProvider getItemProvider(PagedGui<?> gui) {
        ...
        List<String> loreList = gui.hasPreviousPage() && lore != null ?
